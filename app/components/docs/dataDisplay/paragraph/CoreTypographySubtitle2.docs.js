...
import {CoreTypographySubtitle2} from "@wrappid/core";

export default function CoreTypographySubtitle2Docs() {

  return (
    <CoreTypographySubtitle2>CoreTypographySubtitle2. CoreTypographySubtitle2</CoreTypographySubtitle2>
  );
}
`;
  ...
  return (
    <>
      ...
      <PropsSection
        ...
        subtitle={
          "The component maps the variant prop to a range of different HTML element types. For instance, subtitle1 to <h6>. If you wish to change that mapping, you can provide your own."
        }
        types={"object"}
        defaultProp={true}
        defaultType={
...
// all stuff related to CoreTypographySubtitle2
